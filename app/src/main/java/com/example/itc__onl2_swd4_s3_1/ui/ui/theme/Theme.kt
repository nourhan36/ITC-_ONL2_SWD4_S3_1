...
private val DarkColorScheme = darkColorScheme(
    ...
    onBackground = Color(0xFFE7DFCF), // Use this for text on background
    surface = Color(0xFF1E1E1E),
    onSurface = Color(0xFFE7DFCF),    // Use this for text on surface
    error = Color(0xFFF28B82),
    onError = Color.White // Improved contrast for error texts
)
...
// FirebaseAuthDemoAppTheme remains the same if needed